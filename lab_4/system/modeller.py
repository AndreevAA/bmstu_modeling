from .distribution import Uniform, Erlang
from .generator import Generator
from .processor import Processor


class Modeller:
    def __init__(self, uniform_a, uniform_b, g_shape, g_scale, reenter_prop):
        self._generator = Generator(Uniform(uniform_a, uniform_b))
        self._processor = Processor(Erlang(g_shape, g_scale, reenter_prop), reenter_prop)
